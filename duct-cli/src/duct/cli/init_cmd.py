...
def init(ctx: click.Context) -> None:
    ...
    output("  1. Set your Jira domain:  duct config set jira.domain YOUR_DOMAIN.atlassian.net")
    ...
    output("  4. Run your first sync:  duct sync --force")
    output("  5. Check setup:  duct doctor")
